...
namespace HW_2.Migrations
{
    ...
    [Migration("20241215123626_initial2.0")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HW_2.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HW_2.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HW_2.Models.Storage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HW_2.Models.Product", b =>
                {
                    b.HasOne("HW_2.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ProductStorage", b =>
                {
                    b.HasOne("HW_2.Models.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HW_2.Models.Storage", null)
                        .WithMany()
